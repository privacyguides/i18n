...
!!! recommendation
    ...
    **Kicksecure**—in oversimplified terms—is a set of scripts, configurations, and packages that substantially reduce the attack surface of Debian. Den täcker många rekommendationer för sekretess och skydd av integritet som standard. It also serves as the base OS for [Whonix](#whonix).
