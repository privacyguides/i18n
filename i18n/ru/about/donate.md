...
<dl>
  ...
  <dt>
    <strong x-id="1">Онлайн-сервисов</strong>
  </dt>
  ...
  <dt>
    <strong x-id="1">Покупки продукции</strong>
  </dt>
  
  <dd>
    <p spaces-before="0">
      Иногда мы приобретаем продукты и услуги для тестирования <a href="../tools.md">рекомендуемых нами инструментов</a>.
    </p>
  </dd>
</dl>
