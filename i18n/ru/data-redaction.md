...
Когда вы делитесь с кем-то файлами, то не забудьте удалить связанные с ними метаданные. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. Иногда фотографии даже содержат ваши GPS координаты в метаданных файла.
