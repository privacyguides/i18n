...
[Firefox Suggest](https://support.mozilla.org/kb/firefox-suggest) is a feature similar to search suggestions. Ми рекомендуємо вимкнути її з тієї ж причини, з якої ми рекомендуємо вимкнути пошукові пропозиції. Якщо ви не бачите цих опцій під заголовком **адресного рядка**, ви не маєте нового досвіду і можете проігнорувати ці зміни.
