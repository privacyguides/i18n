...
Zapobiega to niezamierzonemu łączeniu się z witryną internetową w postaci zwykłego tekstu HTTP. HTTP is extremely uncommon nowadays, so this should have little to no impact on your day-to-day browsing.
