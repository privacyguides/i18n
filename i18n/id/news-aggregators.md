...
**Newsboat** adalah pembaca umpan RSS/Atom untuk konsol teks. Ini adalah fork yang dipelihara secara aktif dari [Newsbeuter](https://en.wikipedia.org/wiki/Newsbeuter). It is very lightweight and ideal for use over [Secure Shell](https://en.wikipedia.org/wiki/Secure_Shell).
