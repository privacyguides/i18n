...
Saat berbagi file, pastikan untuk menghapus metadata terkait. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. Foto terkadang bahkan menyertakan koordinat GPS dalam metadata file.
