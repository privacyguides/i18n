...
**Pi-hole** is an open-source DNS sinkhole which features a friendly web interface to view insights and manage blocked content. Pi-hole 設計應用在 Raspberry Pi ，但它並不限於這種硬體。
