...
| [**Mullvad**](https://mullvad.net/en/help/dns-over-https-and-dns-over-tls) | DoH <br>DoT                                                        | Non[^4]                                       | Non                                                            | Dépend du serveur choisi. La liste des filtres utilisés peut être consultée ici. [:octicons-link-external-24:](https://github.com/mullvad/dns-adblock)           | Oui [:octicons-link-external-24:](https://github.com/mullvad/encrypted-dns-profiles)                                                                                                                                        |
| [**Quad9**](https://quad9.net)                                             | Cleartext <br>DoH/3 <br>DoT <br>DoQ <br>DNSCrypt | Anonymisé[^5]                                 | Optionnel                                                      | Dépend du serveur choisi. La protection contre les logiciels malveillants est incluse par défaut.                                                                | Oui <br>[:simple-apple: iOS](https://docs.quad9.net/Setup_Guides/iOS/iOS_14_and_later_(Encrypted)) <br>[:material-apple-finder: macOS](https://docs.quad9.net/Setup_Guides/MacOS/Big_Sur_and_later_(Encrypted)) |
...
- Ne doit enregistrer aucunes données personnelles sur le disque.
    - Comme précisé dans les notes de bas de page, certains fournisseurs collecte les informations de requête à des fin de recherche en sécurité par exemple, mais dans ce cas, les données ne doivent pas être associées à des IPI comme les adresses IP, etc.
...
[^1]: AdGuard stocke des mesures de performance agrégées de ses serveurs DNS, à savoir le nombre de demandes complètes adressées à un serveur particulier, le nombre de demandes bloquées et la vitesse de traitement des demandes. Ils conservent également la base de donnée des domaines demandés dans les dernières 24 heures.
    ...
    Control D : [*Poilitque de Confidentialité*](https://controld.com/privacy) [^4]: Le service de DNS de Mullvad est disponible pour les abonnés de Mullvad DNS comme pour les non-abonnés. Leur politique de confidentialité affirme explicitement qu'ils n'enregistrent pas les requêtes DNS de quelque manière que ce soit.

    Mullvad : [*Politique de non-enregistrement des données d'activité des utilisateurs*](https://mullvad.net/en/help/no-logging-data-policy) [^5]: Quad9 collecte certaines données à des fin de surveillance et de gestion des menaces. Ces données peuvent ensuite être remélangées et partagées à des fin de recherche sur la sécurité. Quad9 ne collecte ni n'enregistre les adresses IP ou d'autres données qu'elle juge personnellement identifiables.
