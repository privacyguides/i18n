...
**Mastodon** è un social network basato su protocolli web aperti e su software libero e open source. It uses the decentralized **:simple-activitypub: ActivityPub** protocol.
