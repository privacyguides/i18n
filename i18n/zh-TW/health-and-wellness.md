...
[:octicons-info-16:](https://bloodyhealth.gitlab.io/faq){ .card-link title="文件" }
[:octicons-code-16:](https://gitlab.com/bloodyhealth/drip){ .card-link title="原始碼" }
...
[:octicons-code-16:](https://github.com/Euki-Inc/Euki-Android){ .card-link title="原始碼" }
[:octicons-heart-16:](https://every.org/euki-app){ .card-link title="貢獻" }
...
[:octicons-code-16:](https://codeberg.org/Freeyourgadget/Gadgetbridge){ .card-link title="原始碼" }
[:octicons-heart-16:](https://liberapay.com/Gadgetbridge/donate){ .card-link title="貢獻" }
...
這些應用程式可協助您蒐集與管理個人健康資料，並與醫療服務提供者、機構與其他應用程式分享。
