...
파일을 공유할 때에는 관련 메타데이터를 제거해야 합니다. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. 사진 파일 메타데이터에는 GPS 좌표가 포함될 때도 있습니다.
