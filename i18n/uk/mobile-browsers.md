...
Це запобігає ненавмисному з'єднанню з вебсайтом за допомогою звичайного HTTP. HTTP is extremely uncommon nowadays, so this should have little to no impact on your day-to-day browsing.
