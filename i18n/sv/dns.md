...
| [**Mullvad**](https://mullvad.net/en/help/dns-over-https-and-dns-over-tls) | DoH <br>DoT                                                        | Nej[^4]                      | Nej                                                            | Beroende på val av server. Filterlistan som används hittar du här. [:octicons-link-external-24:](https://github.com/mullvad/dns-adblock)           | Ja [:octicons-link-external-24:](https://github.com/mullvad/encrypted-dns-profiles)                                                                                                                                        |
| [**Quad9**](https://quad9.net)                                             | Cleartext <br>DoH/3 <br>DoT <br>DoQ <br>DNSCrypt | Anonymiserad[^5]             | Valfritt                                                       | Beroende på val av server. Skadeprogram blockering ingår som standard.                                                                             | Ja <br>[:simple-apple: iOS](https://docs.quad9.net/Setup_Guides/iOS/iOS_14_and_later_(Encrypted)) <br>[:material-apple-finder: macOS](https://docs.quad9.net/Setup_Guides/MacOS/Big_Sur_and_later_(Encrypted)) |
