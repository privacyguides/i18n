...
If you're looking for added **security**, you should always ensure you're connecting to websites using HTTPS. VPNは、優れたセキュリティーの代わりにはなりません。
...
- ![Proton Mail logo](assets/img/email/protonmail.svg){ .lg .middle .twemoji } **Proton Mail**
    ...
    Proton Mail is an email service with a focus on privacy, encryption, security, and ease of use. They have been in operation since 2013. Proton AGはスイスのジュネーブを拠点としています。 Proton Mailの無料プランのメールストレージは500MBから始まり、無料で1GBまで増やすことができます。
...
- ![Mailbox Mail logo](assets/img/email/mailbox-mail.svg){ .lg .middle .twemoji } **Mailbox Mail**
    ...
    Mailbox Mail (formerly *Mailbox.org*) is an email service with a focus on being secure, ad-free, and powered by 100% eco-friendly energy. 2014年から運営をされています。 Mailbox Mail is based in Berlin, Germany. 各アカウントには最大2GBのストレージが割当てられ、必要に応じてアップグレードできます。
...
[詳細 :material-arrow-right-drop-circle:](data-broker-removals.md)
...
[詳細 :material-arrow-right-drop-circle:](photo-management.md)
...
[詳細 :material-arrow-right-drop-circle:](ai-chat.md)
...
[詳細 :material-arrow-right-drop-circle:](document-collaboration.md)
...
[詳細 :material-arrow-right-drop-circle:](encryption.md#operating-system-encryption)
...
[詳細 :material-arrow-right-drop-circle:](health-and-wellness.md)
...
[詳細 :material-arrow-right-drop-circle:](language-tools.md)
...
[詳細 :material-arrow-right-drop-circle:](maps.md)
...
[詳細 :material-arrow-right-drop-circle:](office-suites.md)
...
[詳細 :material-arrow-right-drop-circle:](pastebins.md)
...
[詳細 :material-arrow-right-drop-circle:](social-networks.md)
...
[詳細 :material-arrow-right-drop-circle:](mobile-phones.md)
...
[詳細 :material-arrow-right-drop-circle:](android/distributions.md)
...
[詳細 :material-arrow-right-drop-circle:](android/general-apps.md)
...
[詳細 :material-arrow-right-drop-circle:](android/obtaining-apps.md)
...
[詳細 :material-arrow-right-drop-circle:](alternative-networks.md)
