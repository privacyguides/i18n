...
**Standard Notes** is a simple and private notes app that features cross-platform sync for seamless use. Den har E2EE på alla plattformar och en kraftfull skrivbordsupplevelse med teman och anpassade redaktörer.
...
It can sync through Nextcloud, Dropbox, and more. Det erbjuder också enkel import från Evernote och vanlig text anteckningar.
...
**Cryptee** är en webbaserad E2EE-dokumentredigerare med öppen källkod och ett program för lagring av foton.
