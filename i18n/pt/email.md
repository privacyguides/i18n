...
Mailbox Mail allows for encryption of incoming mail using their [encrypted mailbox](https://kb.mailbox.org/en/private/encryption/your-encrypted-mailbox/). As novas mensagens recebidas serão imediatamente encriptadas com a sua chave pública.
