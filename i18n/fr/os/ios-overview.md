...
- [x] Activer l'option **Installation automatique**
...
Cette fonction est disponible si votre appareil est compatible avec **[Apple Intelligence](https://support.apple.com/guide/iphone/apple-intelligence-and-privacy-iphe3f499e0e/ios)**. Apple Intelligence utilise une combinaison de traitement sur l'appareil et de son **[Private Cloud Compute](https://security.apple.com/blog/private-cloud-compute) ** pour les tâches qui nécessitent une puissance de traitement supérieure à celle que votre appareil peut fournir.

Pour consulter un rapport de toutes les requêtes adressées aux serveurs d'Apple, vous pouvez naviguer jusqu'à **Confidentialité & Sécurité** → **Rapport d'intelligence Apple** et appuyer sur **Exporter l'activité** pour voir l'activité des 15 dernières minutes ou des 7 derniers jours, en fonction de ce que vous avez paramétré. Cette fonctionnalité, assez similaire au **Rapport de confidentialité des apps** qui permet de connaitre les permissions récemment utilisées par les applications sur votre téléphone, vous permet de consulter ce qui est envoyé aux serveurs d'Apple lorsque vous utilisez Apple Intelligence.

Apple Intelligence peut s'intégrer à [ChatGPT](https://support.apple.com/guide/iphone/use-chatgpt-with-apple-intelligence-iph00fd3c8c2/ios). Si vous souhaitez intégrer ChatGPT, rendez-vous sur **la page ChatGPT** et cliquez sur « **Configurer** ». Si vous souhaitez le désactiver, rendez-vous au même endroit :
...
Si vous utilisez les déverouillages biométriques, vous devez savoir comment les désactiver rapidement en cas d'urgence. Si vous maintenez enfoncés le [bouton latéral](https://support.apple.com/en-us/105103) et *l'un des* boutons de volume jusqu'à ce que le curseur « Glisser pour éteindre » s'affiche, les fonctions biométriques seront désactivées et vous devrez saisir votre code d'accès pour déverrouiller l'appareil. Votre code d'accès sera requis après le redémarrage de votre appareil.

Vous pouvez également désactiver la reconnaissance biométrique en appuyant cinq fois sur le bouton latéral ; sur les appareils équipés de Touch ID, il suffit de maintenir le bouton latéral enfoncé, sans rien faire d'autre. Assurez-vous faire un essai préalable afin de savoir quelle méthode fonctionne pour votre appareil.

**Protection en cas de vol de l’appareil** est une nouvelle fonctionnalité d'iOS  qui ajoute une sécurité supplémentaire destinée à protéger vos données personnelles si votre appareil est volé lorsqu'il est déverrouillé. Si vous activez à la fois l'authentification biométrique et la fonctionnalité « [Localiser mon](#find-my) iPhone », nous vous recommandons d'activer cette protection :

- [x] Activer **la protection contre le vol d'appareil**
...
**Autoriser l'accès lorsque le téléphone est verrouillé** vous offre des options pour définir ce que vous pouvez autoriser lorsque votre téléphone est verrouillé. Choisissez les fonctions que vous souhaitez désactiver pour empêcher tout accès non autorisé si quelqu'un met la main sur votre téléphone. Plus vous désactivez d'options, moins quelqu'un qui n'a pas votre mot de passe peut faire de choses, mais moins c'est pratique pour vous.
...
**[Vérification de sécurité](https://support.apple.com/guide/personal-safety/safety-check-iphone-ios-16-ips2aad835e1/1.0/web/1.0)** vous permet de consulter rapidement et de révoquer l'accès de certaines personnes et applications susceptibles d'avoir l'autorisation d'accéder à vos données. Ici, vous pouvez effectuer une **réinitialisation d'urgence**, qui réinitialise immédiatement les autorisations de toutes les personnes et applications susceptibles d'avoir accès aux ressources de l'appareil. Vous pouvez également **gérer les droits d'accès au partage & **, ce qui vous permet de vérifier et de personnaliser les personnes et les éléments ayant accès à votre appareil et aux ressources de votre compte. Si vous êtes victime de violences, consultez [le Guide de sécurité personnelle](https://support.apple.com/guide/personal-safety/welcome/web) d'Apple pour savoir comment réagir.

Vous devez désactiver les statistiques si vous ne souhaitez pas envoyer de données d'utilisation à Apple. Sélectionnez **« Améliorations des données d'analyse » ( & ** ) et désélectionnez le ou les types de données d'analyse que vous ne souhaitez pas envoyer à Apple.
...
Configurez les accessoires filaires pour qu'ils vous demandent l'autorisation lorsque vous les connectez. Sélectionnez **Accessoire Filaires**:

- [x] Sélectionnez « **Toujours demander** » ou « **Demander pour les nouveaux accessoires** »

**[Mode verrouillage](https://blog.privacyguides.org/2022/10/27/macos-ventura-privacy-security-updates/#lockdown-mode)** est un paramètre de sécurité que vous pouvez activer pour rendre votre téléphone plus résistant aux attaques. Sachez que certaines applications et fonctionnalités [ne fonctionneront pas](https://support.apple.com/HT212650) comme elles le font normalement.
...
Par défaut, vous faites confiance aux serveurs d'identité d'Apple pour vous assurer que vous envoyez vos messages à la bonne personne. Pour vous protéger contre un serveur potentiellement malveillant, vous pouvez activer **[la vérification de la clé de contact](https://support.apple.com/en-us/118246)**. En haut de l'application **« Réglages »**, à l'endroit où figure votre nom, sélectionnez-le, puis accédez à « **Vérification de la clé de contact** ».

- [x] Activer **la vérification dans iMessage**

Pour que les mesures de sécurité mentionnées ci-dessus prennent effet, vous et vos contacts devez activer la « Vérification de la clé de contact » et suivre [les instructions](https://support.apple.com/en-us/118246#verify) d'Apple.
...
Il peut parfois vous arriver de vouloir prêter votre téléphone à quelqu'un pour qu'il passe un appel ou effectue une tâche précise, sans pour autant lui donner un accès complet à votre appareil. Dans ces cas-là, vous pouvez rapidement activer **[l'accès guidé](https://support.apple.com/guide/iphone/lock-iphone-to-one-app-iph7fad0d10/ios)** pour verrouiller le téléphone sur une application spécifique jusqu’à ce que vous vous authentifiiez.

<div class="admonition warning" markdown>
<p class="admonition-title">Avertissement</p>

La fonctionnalité « Accès guidé » n'est pas infaillible, car il est possible que vous divulguiez des données par inadvertance ou que cette fonctionnalité soit contournée. Vous ne devriez utiliser l'accès guidé que dans les situations où vous prêtez votre téléphone à quelqu'un de manière informelle. Vous ne devez pas l'utiliser comme outil de protection contre des adversaires très sophistiqués.
...
Sur les appareils compatibles, vous pouvez utiliser la fonctionnalité « [Clean Up](https://support.apple.com/en-us/121429) » pour pixelliser les visages ou supprimer des objets des images.

- Ouvrez l'application **Photos** et appuyez sur la photo que vous avez sélectionnée
- Appuyez sur :material-tune:
...
- Appuyez sur l'image que vous avez sélectionnée pour la cacher
- Appuyez sur :material-tune: → :material-dots-horizontal: (1) → Annotation → :material-plus:
- Sélectionnez **Ajouter une forme** et choisissez le carré ou le cercle
- Dans la barre d'outils, appuyez sur le cercle et choisissez le noir comme couleur de remplissage pour la forme. Vous pouvez également déplacer la forme et augmenter sa taille comme vous le souhaitez.

</div>

1. Cette fonctionnalité peut ne pas être disponible sur certains modèles d'iPhone.
...
Les iPhone [redémarrent automatiquement](https://support.apple.com/guide/security/protecting-user-data-in-the-face-of-attack-secf5549a4f5/1/web/1#:~:text=On%20an%20iPhone%20or%20iPad%20with%20iOS%2018%20and%20iPadOS%2018%20or%20later%2C%20a%20new%20security%20protection%20will%20restart%20devices%20if%20they%20remain%20locked%20for%20a%20prolonged%20period%20of%20time.) s'ils ne sont pas déverrouillés au bout d'un certain temps.



### MTE

La gamme iPhone 17 et les modèles ultérieurs intègrent une amélioration de sécurité appelée « [Memory Tagging Extension](https://developer.arm.com/documentation/108035/0100/Introduction-to-the-Memory-Tagging-Extension) » (MTE), qui complique considérablement la tâche d'un pirate souhaitant exploiter des failles liées à la corruption de mémoire. Cette protection permanente dépend de la prise en charge matérielle ; elle n'est donc pas disponible sur les appareils plus anciens.

Pour plus d'informations sur la mise en œuvre de la technologie MTE par Apple, consultez [l'article de blog](https://security.apple.com/blog/memory-integrity-enforcement) publié par Apple Security Research. Dans notre [propre article](https://www.privacyguides.org/posts/2025/09/20/memory-integrity-enforcement-changes-the-game-on-ios), nous abordons également la mise en œuvre de la technologie MTE par Apple et la comparons à celle d'Android sur la série Google Pixel 8 et les modèles ultérieurs.
