...
Cuando compartas archivos, asegúrate de remover los metadatos asociados. Los tipos de archivos más comunes (incluyendo documentos, imágenes y vídeos) incluyen metadatos. Archivos de imágenes, por ejemplo, normalmente contienen datos Exif. Fotos a veces incluyen hasta coordenadas GPS en los metadatos del archivo.

Windows cuenta con una herramienta para el borrado de metadatos, pero desgraciadamente no puede eliminar muchos tipos de datos como:

- Documentos: Comentarios, nombre del autor, control de cambios, hojas de cálculo ocultas, notas de las diapositivas, XML personalizado e historiales de revisión del documento.
- Imágenes: Número de serie de la cámara, datos XMP/IPTC, metadatos C2PA y miniaturas de las imágenes (que pueden exponer de forma peligrosa detalles originales que zonas recortadas o borradas).
- Audio y Vídeo: motadatos XMP, metadatos C2PA y ciertos campos de etiquetas ID3v2.
- Archivos incrustados: metadatos ocultos incrustados dentro de imágenes que están embebidas en los documentos.
