...
Non. Privacy Guides ne vend pas vos données personnelles. De plus, Privacy Guides ne partage pas vos données personnelles à des tiers à des fins publicitaires.
...
| dosp                                                          | Oui       | Prochaine consultation de page | active la protection contre les attaques par déni de service au niveau du client, une mesure de sécurité               |
...
| [Posts et activité](#privacy-guides-collects-data-about-posts-and-other-activity)                   | Contenu de vos posts, données d'activité comme les marques pages, les likes et les liens que vous suivez                    | **Obligation légale** | Requis pour vous fournir nos services selon nos conditions d'utilisation                                                                                                                                                                                  |
| [Posts et activité](#privacy-guides-collects-data-about-posts-and-other-activity)                   | Contenu de vos messages privés                                                                                              | **Obligation légale** | Requis pour vous fournir nos services selon nos conditions d'utilisation                                                                                                                                                                                  |
| [Posts et activité](#privacy-guides-collects-data-about-posts-and-other-activity)                   | Adresse mail                                                                                                                | **Obligation légale** | Notre forum est une plateforme basée sur l'email, et les notifications par email à propos de l'activité du forum font partie intégrante de celui-ci et sont nécessaires pour vous fournir nos services en accord avec nos conditions d'utilisation        |
...
Privacy Guides partage des données concernant vos posts et votre activité à des tiers comme précisé dans la [section à propos des données de forum](#privacy-guides-collects-data-about-posts-and-other-activity).
...
Vous pouvez nous envoyer vos questions, requêtes et plaintes par mail à l'adresse suivante : <team@privacyguides.org> . Vous pouvez également utiliser Signal ou un autre [moyen de contact](about.md#contact-us) pour nous contacter de manière plus sécurisée.
