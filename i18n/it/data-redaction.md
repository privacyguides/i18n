...
Condividendo dei file, assicurati di rimuovere i metadati associati. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. Talvolta, le foto, includono persino le coordinate GPS nei metadati del file.
