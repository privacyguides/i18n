...
<p spaces-before="0">
  Χρησιμοποιούμε τις δωρεές για διάφορους σκοπούς, όπως:
</p>
...
<dl>
  ...
  <dt>
    <strong x-id="1">Διαδικτυακές Υπηρεσίες</strong>
  </dt>
  ...
  <dt>
    <strong x-id="1">Αγορές προϊόντων</strong>
  </dt>
  
  <dd>
    <p spaces-before="0">
      Αγοράζουμε περιστασιακά προϊόντα και υπηρεσίες με σκοπό την δοκιμή των <a href="../tools.md">συνιστώμενων εργαλείων</a> μας.
    </p>
  </dd>
</dl>
