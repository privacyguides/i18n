...
1. **誤った情報を拡散しない**
      ...
      私たちは、陰謀論の巣窟ではなく、プライバシーとセキュリティに関する根拠に基づいた教育コミュニティを構築しています。 たとえば、特定のソフトウェアが悪意のあるものであると主張する場合、または特定のテレメトリーデータがプライバシーを侵害していると主張する場合、 収集される内容と収集方法を詳細に説明してください。 このような主張は、技術的な証拠に基づいていなければなりません。
