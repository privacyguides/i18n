...
共享文件时，请务必删除关联的元数据。 Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. 照片有时甚至包括文件元数据中的GPS坐标。
