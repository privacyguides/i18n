...
![Logo de Mailbox Mail](assets/img/email/mailbox-mail.svg){ align=right }
...
Mailbox Mail vous permet d'utiliser votre propre nom de domaine et prend en charge les adresses « [catch-all](https://kb.mailbox.org/en/private/custom-domains/use-your-own-domain-with-catch-all/) ». Mailbox Mail prend également en charge le [sous-adressage](https://kb.mailbox.org/en/private/e-mail/what-is-an-alias-and-how-do-i-use-it/), ce qui est utile si vous ne souhaitez pas acheter un domaine.
