...
[^1]: `IsolateDestAddr` 設定在 [Tor 郵件論壇](https://lists.torproject.org/pipermail/tor-talk/2012-May/024403)與 [Whonix 的串流隔離文件](https://whonix.org/wiki/Stream_Isolation)上討論過，這兩個專案均表明，對大多數人來說，這通常並非良策。
