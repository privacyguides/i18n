...
Executamos uma instalação auto-hospedada do Umami para recolher alguns dados de utilização anônimos para fins estatísticos. The goal is to track overall trends in our website traffic, it is not to track individual visitors. All the data is in aggregate only, and no personal data is stored.
