...
<dl>
  ...
  <dt>
    <strong x-id="1">שירותים מקוונים</strong>
  </dt>
  ...
  <dt>
    <strong x-id="1">רכישת מוצרים</strong>
  </dt>
  
  <dd>
    <p spaces-before="0">
      מדי פעם אנו רוכשים מוצרים ושירותים לצורך בדיקת <a href="../tools.md">הכלים המומלצים שלנו</a>.
    </p>
  </dd>
</dl>
