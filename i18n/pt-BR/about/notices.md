...
This does not include third-party code embedded in the Privacy Guides code repository, or code where a superseding license is otherwise noted. Os exemplos seguintes são notáveis, mas esta lista pode não incluir tudo:
