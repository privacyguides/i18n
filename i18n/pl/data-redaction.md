...
Udostępniając pliki, pamiętaj o usunięciu powiązanych metadanych. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. Zdjęcia czasem zawierają nawet współrzędne GPS w metadanych pliku.
