...
När du delar filer ska du se till att ta bort tillhörande metadata. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. Foton innehåller ibland även GPS-koordinater i filmetadata.
