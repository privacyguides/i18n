...
**Akregator** — это читалка лент новостей, которая является частью проекта [KDE](https://kde.org). It comes with a fast search, advanced archiving functionality, and an internal browser for easy news reading.
