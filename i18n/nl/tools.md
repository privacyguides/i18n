...
- ![Proton Mail logo](assets/img/email/protonmail.svg){ .lg .middle .twemoji } **Proton Mail**
    ...
    Proton Mail is an email service with a focus on privacy, encryption, security, and ease of use. They have been in operation since 2013. Proton AG is gevestigd in Genève, Zwitserland. The Proton Mail Free plan comes with 500 MB of Mail storage, which you can increase up to 1 GB for free.
...
- ![Mailbox Mail logo](assets/img/email/mailbox-mail.svg){ .lg .middle .twemoji } **Mailbox Mail**
    ...
    Mailbox Mail (formerly *Mailbox.org*) is an email service with a focus on being secure, ad-free, and powered by 100% eco-friendly energy. Ze zijn sinds 2014 in bedrijf. Mailbox Mail is gevestigd in Berlijn, Duitsland. Accounts start with up to 2 GB storage, which can be upgraded as needed.
...
[Meer informatie :material-arrow-right-drop-circle:](email-clients.md)
...
[Meer informatie :material-arrow-right-drop-circle:](cloud.md)
...
[Meer informatie :material-arrow-right-drop-circle:](data-broker-removals.md)

### DNS

#### DNS Providers

We [recommend](dns.md#recommended-providers) a number of encrypted DNS servers based on a variety of criteria, such as [Quad9](https://quad9.net) amongst others. Wij raden je aan onze pagina's over DNS te lezen voordat je een provider kiest. In veel gevallen wordt het gebruik van een alternatieve DNS-provider niet aanbevolen.
...
[Meer informatie :material-arrow-right-drop-circle:](dns.md#encrypted-dns-proxies)
...
[Meer informatie :material-arrow-right-drop-circle:](photo-management.md)
...
[Meer informatie :material-arrow-right-drop-circle:](ai-chat.md)
...
[Meer informatie :material-arrow-right-drop-circle:](data-redaction.md)
...
[Meer informatie :material-arrow-right-drop-circle:](document-collaboration.md)
...
[Meer informatie :material-arrow-right-drop-circle:](encryption.md#openpgp)
...
[Meer informatie :material-arrow-right-drop-circle:](file-sharing.md)
...
[Meer informatie :material-arrow-right-drop-circle:](frontends.md)
...
[Meer informatie :material-arrow-right-drop-circle:](health-and-wellness.md)
...
[Meer informatie :material-arrow-right-drop-circle:](language-tools.md)
...
[Meer informatie :material-arrow-right-drop-circle:](maps.md)
...
[Meer informatie :material-arrow-right-drop-circle:](multi-factor-authentication.md)
...
[Meer informatie :material-arrow-right-drop-circle:](news-aggregators.md)
...
[Meer informatie :material-arrow-right-drop-circle:](notebooks.md)
...
[Meer informatie :material-arrow-right-drop-circle:](office-suites.md)
...
[Meer informatie :material-arrow-right-drop-circle:](passwords.md)
...
[Meer informatie :material-arrow-right-drop-circle:](pastebins.md)
...
[Meer informatie :material-arrow-right-drop-circle:](social-networks.md)
...
[Meer informatie :material-arrow-right-drop-circle:](mobile-phones.md)
...
[Meer informatie :material-arrow-right-drop-circle:](android/distributions.md)
...
[Meer informatie :material-arrow-right-drop-circle:](android/general-apps.md)
...
[Meer informatie :material-arrow-right-drop-circle:](android/obtaining-apps.md)
...
[Meer informatie :material-arrow-right-drop-circle:](desktop.md)
...
[Meer informatie :material-arrow-right-drop-circle:](alternative-networks.md)
