...
[Mullvad Browser](#mullvad-browser) poskytuje ve výchozím nastavení lepší ochranu proti fingerprintingu než Firefox a nevyžaduje používání Mullvad VPN, abyste mohli tuto ochranu používat. Ve spojení s VPN umí Mullvad Browser sabotovat pokročilejší sledovací skripty, které Arkenfox sabotovat nedokáže. Firefox ale naproti tomu nabízí větší flexibilitu a umožňuje výjimky pro jednotlivé stránky, na kterých potřebujete zůstat přihlášeni.

</div>

[Projekt Arkenfox](https://github.com/arkenfox/user.js) nabízí sadu pečlivě zvážených funkcí Firefoxu. Pokud se [rozhodnete](https://github.com/arkenfox/user.js/wiki/1.1-To-Arkenfox-or-Not) používat Arkenfox, [několik nastavení](https://github.com/arkenfox/user.js/wiki/3.2-Overrides-%5BCommon%5D) pro vás může být až moc přísných a/nebo může způsobit, že některé stránky nebudou fungovat správně —nastavení ale můžete [snadno upravit](https://github.com/arkenfox/user.js/wiki/3.1-Overrides), aby vyhovovalo vašim potřebám. **Velmi doporučujeme**, abyste si prošli celou jejich [wiki](https://github.com/arkenfox/user.js/wiki). Arkenfox také umožňuje podporu [kontejnerů](https://support.mozilla.org/kb/containers#w_for-advanced-users).
