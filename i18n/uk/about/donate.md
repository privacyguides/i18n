...
<dl>
  ...
  <dt>
    <strong x-id="1">Онлайн-сервіси</strong>
  </dt>
  ...
  <dt>
    <strong x-id="1">Придбання продукції</strong>
  </dt>
  
  <dd>
    <p spaces-before="0">
      Час від часу ми купуємо продукти та послуги з метою тестування наших <a href="../tools.md">рекомендованих інструментів</a>.
    </p>
  </dd>
</dl>
