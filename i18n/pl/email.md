...
- Szyfrowanie w spoczynku, przy użyciu szyfrowania asymetrycznego, w którym dostawca usług nie posiada kluczy deszyfrujących do przechowywanych przez siebie danych. This prevents a rogue employee leaking data they have access to, or a remote adversary from releasing data they have stolen by gaining unauthorized access to the server.
