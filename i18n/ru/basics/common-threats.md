...
<span class="pg-green">:material-account-search: **Информация в открытом доступе**</span>
:
...
## Атаки, направленные на конкретных лиц
...
## Атаки, направленные на определённые организации
