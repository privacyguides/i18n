...
| [**Control D Free DNS**](https://controld.com/free-dns)                    | [:octicons-link-external-24:](https://controld.com/privacy)                                          | Cleartext   DoH/3   DoT   DoQ            | Optional[^3] | No                                                             | Based on server choice.                                                                                                                    | Ja [:octicons-link-external-24:](https://docs.controld.com/docs/macos-platform)                                           |
| [**dns0.eu**](https://dns0.eu)                                             | [:octicons-link-external-24:](https://dns0.eu/privacy)                                               | Cleartext   DoH/3   DoH   DoT   DoQ      | No           | Anonymized                                                     | Based on server choice.                                                                                                                    | Ja [:octicons-link-external-24:](https://www.dns0.eu/zero.dns0.eu.mobileconfig)                                           |
...
| [**Quad9**](https://quad9.net)                                             | [:octicons-link-external-24:](https://quad9.net/privacy/policy)                                      | Cleartext   DoH   DoT   DNSCrypt         | Some[^5]     | Optional                                                       | Based on server choice, malware blocking by default.                                                                                       | Ja [:octicons-link-external-24:](https://quad9.net/news/blog/ios-mobile-provisioning-profiles)                            |
