...
Ao compartilhar arquivos, é importante remover metadados associados. Most common file types (including documents, images, and videos) include metadata. Image files, for example, commonly include Exif data. Às vezes, as fotos incluem até mesmo coordenadas de GPS nos metadados do arquivo.
