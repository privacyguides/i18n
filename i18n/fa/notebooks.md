...
**Standard Notes** is a simple and private notes app that features cross-platform sync for seamless use. دارای E2EE در هر پلتفرم و تجربه قدرتمند دسکتاپ با تم ها و ویرایشگرهای سفارشی است.
