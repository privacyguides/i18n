...
[^5]: NextDNS can provide insights and logging features on an opt-in basis. You can choose retention times and log storage locations for any logs you choose to keep. 特に要求されていない場合は、データは記録されません。 [https://nextdns.io/privacy](https://nextdns.io/privacy)
