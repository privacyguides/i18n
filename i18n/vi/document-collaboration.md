...
![OnlyOffice logo](assets/img/productivity/onlyoffice.svg){ align=right }**OnlyOffice** là lựa chọn thay thế, đây là bộ ứng dụng văn phòng mã nguồn mở miễn phí với nhiều chức năng. For this reason, we don't recommend third-party Nextcloud providers.
