...
**Standard Notes** is a simple and private notes app that features cross-platform sync for seamless use. Possui E2EE em todas as plataformas e uma poderosa experiência de desktop com temas e editores personalizados.
...
It can sync through Nextcloud, Dropbox, and more. Oferece também uma importação fácil a partir do Evernote e notas de texto simples.
