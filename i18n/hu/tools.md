...
- ![Tor Browser logo](assets/img/browsers/tor.svg){ .twemoji } [Tor Böngésző](tor.md#tor-browser)
- ![Orbot logo](assets/img/self-contained-networks/orbot.svg){ .twemoji } [Orbot (Okostelefon Tor Proxy)](tor.md#orbot)
...
[További információ :material-arrow-right-drop-circle:](desktop-browsers.md#additional-resources)
...
[További információ :material-arrow-right-drop-circle:](mobile-browsers.md#adguard)
...
[További információ :material-arrow-right-drop-circle:](android.md)
...
[További információ :material-arrow-right-drop-circle:](android.md#general-apps)
...
[További információ :material-arrow-right-drop-circle:](desktop.md)
...
[További információ :material-arrow-right-drop-circle:](dns.md#self-hosted-solutions)
...
[További információ :material-arrow-right-drop-circle:](data-redaction.md)
...
- ![VeraCrypt logo](assets/img/encryption-software/veracrypt.svg#only-light){ .twemoji }![VeraCrypt logo](assets/img/encryption-software/veracrypt-dark.svg#only-dark){ .twemoji } [VeraCrypt (TLT)](encryption.md#veracrypt-disk)
- ![Hat.sh logo](assets/img/encryption-software/hat-sh.png#only-light){ .twemoji }![Hat.sh logo](assets/img/encryption-software/hat-sh-dark.png#only-dark){ .twemoji } [Hat.sh (Böngésző alapú)](encryption.md#hatsh)
...
[További információ :material-arrow-right-drop-circle:](encryption.md#openpgp)

### Fájlmegosztás és Szinkronizálás
...
- ![Nextcloud logo](assets/img/productivity/nextcloud.svg){ .twemoji } [Nextcloud (Sajár Üzemeltetésű)](productivity.md#nextcloud)
- ![Syncthing logo](assets/img/file-sharing-sync/syncthing.svg){ .twemoji } [Syncthing](file-sharing.md#syncthing)

</div>

[További információ :material-arrow-right-drop-circle:](file-sharing.md)
...
- ![FreeTube logo](assets/img/frontends/freetube.svg){ .twemoji } [FreeTube (YouTube, Asztal)](frontends.md#freetube)
...
[További információ :material-arrow-right-drop-circle:](multi-factor-authentication.md)
...
[További információ :material-arrow-right-drop-circle:](news-aggregators.md)
...
[További információ :material-arrow-right-drop-circle:](notebooks.md)
...
- ![Strongbox logo](assets/img/password-management/strongbox.svg){ .twemoji } [Strongbox (iOS és macOS)](passwords.md#strongbox-ios-macos)
- ![gopass logo](assets/img/password-management/gopass.svg){ .twemoji } [gopass](passwords.md#gopass)

</div>

[További információ :material-arrow-right-drop-circle:](passwords.md)

### Produktivitás Eszközök

<div class="grid cards" markdown>

- ![Nextcloud logo](assets/img/productivity/nextcloud.svg){ .twemoji } [Nextcloud (Saját Üzemeltetésű)](productivity.md#nextcloud)
...
[További információ :material-arrow-right-drop-circle:](productivity.md)
...
- ![Briar logo](assets/img/messengers/briar.svg){ .twemoji } [Briar](real-time-communication.md#briar-android)
