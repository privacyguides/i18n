...
Модификации, отличные от регулировки этой настройки, сделают ваш отпечаток уникальным, что сведет на нет цель использования этого браузера. Если вы хотите более комплексно настроить браузер, и вас не беспокоит фингерпринтинг, то мы рекомендуем использовать [Firefox](#firefox).
...
Mullvad Browser поставляется с предустановленными расширениями *uBlock Origin* и *NoScript*. Хотя мы обычно не рекомендуем добавлять *дополнительные* [расширения для браузера](browser-extensions.md), эти расширения, которые поставляются предустановленными в браузер, **не** следует удалять или настраивать, потому что это сделает ваш отпечаток браузера заметно отличным от других пользователей Mullvad Browser. Он также поставляется с предустановленным расширением Mullvad Browser Extension, которое *можно* безопасно удалить не [повлияв](https://mullvad.net/en/help/tag/mullvad-browser#112) на цифровой отпечаток браузера; оставить его тоже безопасно, даже если вы не используете Mullvad VPN.

### Режим приватного просмотра

Mullvad Browser работает в постоянном режиме приватного просмотра, иначе говоря, ваша история, файлы куки и другие данные сайтов очищаются при каждом закрытии браузера. Однако ваши закладки, настройки браузера и настройки расширений будут сохранены.

Это необходимо для предотвращения продвинутых форм отслеживания, но за это приходится платить удобством и некоторыми функциями Firefox, например Multi-Account Containers. Помните, что всегда можно использовать несколько браузеров, например, можно использовать Firefox+Arkenfox для сайтов, на которых вы хотите оставаться в системе или которые плохо работают в Mullvad Browser, а Mullvad Browser для регулярного пользования.
...
**Firefox** предоставляет сильные настройки конфиденциальности, например [Улучшенная защита от отслеживания](https://support.mozilla.org/kb/enhanced-tracking-protection-firefox-desktop), блокирующие различные [типы слежки](https://support.mozilla.org/kb/enhanced-tracking-protection-firefox-desktop#w_what-enhanced-tracking-protection-blocks).
...
> Согласно Mozilla, [«некоторые части Firefox Suggest в настоящее время доступны только в некоторых регионах».](https://support.mozilla.org/kb/firefox-suggest)
...
##### (англ. DNS over HTTPS) - DNS через HTTPS
