...
**Standard Notes** is a simple and private notes app that features cross-platform sync for seamless use. Het biedt E2EE op elk platform, en een krachtige desktop-ervaring met thema's en aangepaste editors.
...
It can sync through Nextcloud, Dropbox, and more. Het biedt ook een gemakkelijke import vanuit Evernote en notities in gewone tekst.
...
**Cryptee** is een web-gebaseerde, versleutelde, veilige foto opslag service en documenten editor.
